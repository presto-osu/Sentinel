 ...
 */
public class NSensorIdNode extends NIdNode {
  ...
  public static final Map<Integer, String> SENSOR_NAME_MAP = Maps.newHashMap();

  {
    try {
      Field[] fields = NSensorIdNode.class.getFields();
      ...
      for (Field f : fields) {
        if (f.getType().equals(int.class)) {
          if (f.getName().startsWith("TYPE_")) {
            ...
            Field strField = null;
            try {
              strField = NSensorIdNode.class.getField(strName);
            } catch (NoSuchFieldException e) {

            }
            if (strField == null) {
              strField = NSensorIdNode.class.getField("SENSOR_" + strName);
            }
  ...
  public NSensorIdNode(Integer i) {
    super(i, "SID");
  }
  @Override
  ...
  public String getIdName() {
    if (SENSOR_NAME_MAP.containsKey(this.i)) {
      return SENSOR_NAME_MAP.get(this.i);
    } else {
  ...
  public boolean equals(Object b) {
    if (b instanceof NSensorIdNode) {
      NSensorIdNode idB = (NSensorIdNode)b;
      if (idB.i.equals(this.i)) {
        return true;
      }
    }
    return false;
