...
public interface XMLParser {
  abstract class AbstractXMLParser implements XMLParser {
    ...
    public Map<String, List<String>> aliasActivityMap = Maps.newHashMap();
    public Map<String, String> aliasActivityToOriginMap = Maps.newHashMap();
  ...
  class Helper {
    ...
    public static String getClassNameAlias(String classNameFromXml,
                                           String appPkg) {
